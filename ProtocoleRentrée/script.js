...
btnModify.addEventListener('click', function (e) {
    ...
    myModifyForm.addEventListener('submit', function (e) {
        e.preventDefault();
        let form_data = new FormData(myModifyForm);
        let studentNameToEdit = form_data.get('nameInput');
...
btnImport.addEventListener('click', function (e) {
    ...
    let importTitle = myNewElement('h1', "importTitle", '<span class= "fLetter">I</span>importer une base de donné<span class= "lLetter">e</span>', sectionTitle)
